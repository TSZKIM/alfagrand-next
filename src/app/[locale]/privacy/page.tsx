...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: locale === "en" ? "Privacy Policy | ALFAGRAND" : "Privacy Policy | ALFAGRAND",
    description: "ALFAGRAND Privacy Policy — how we collect, use and protect your personal information.",
    alternates: {
      canonical: `${baseUrl}/${locale}/privacy`,
      languages: Object.fromEntries(locales.map((l) => [l, `${baseUrl}/${l}/privacy`])),
    },
      ...
      <main className="bg-bg-primary text-white min-h-screen pt-32 pb-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-invert max-w-none space-y-8 text-text-secondary text-sm leading-relaxed">
            ...
            <section>
              <h2 className="text-white text-lg font-semibold mb-3">{t("s7.title")}</h2>
              <p>{t("s7.content")}</p>
            </section>
          </div>
        </div>
